function [V_command, collisions] = compute_vel_ccece_curvilinear(self, p_swarm, r_agent, dt)
    % ccece-paper CURVILINEAR SWARMING ALGORITHM
    % This is an implementation of the CURVILINEAR SWARMING ALGORITHM. It
